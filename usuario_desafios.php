...
$query = mysql_query("SELECT Count(ID) AS desafios_quantidade FROM Desafios_Resultados WHERE Usuario_1 = '". $id ."' OR Usuario_2 = '". $id ."'");
...
if ($p > $p_total) {
	header("Location: usuario_desafios.php?id=". $id ."&p=1"); break;
}
