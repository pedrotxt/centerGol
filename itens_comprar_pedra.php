...
mysql_query("UPDATE Usuarios SET Dinheiro = Dinheiro - '". $valor_total ."', Item_Pedra = Item_Pedra + '". $q ."' WHERE ID_Cod = password('". $_COOKIE["usuarioid"] ."')");

header("Location: itens_comprar.php?msg_comprar=3"); break;
?>