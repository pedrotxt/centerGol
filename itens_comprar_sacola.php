...
mysql_query("UPDATE Usuarios SET Dinheiro = Dinheiro - '". $valor_total ."', Item_Sacola = Item_Sacola + '". $q ."' WHERE ID_Cod = password('". $_COOKIE["usuarioid"] ."')");

header("Location: itens_comprar.php?msg_comprar=5"); break;
?>