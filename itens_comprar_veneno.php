...
mysql_query("UPDATE Usuarios SET Dinheiro = Dinheiro - '". $valor_total ."', Item_Veneno = Item_Veneno + '". $q ."' WHERE ID_Cod = password('". $_COOKIE["usuarioid"] ."')");

header("Location: itens_comprar.php?msg_comprar=6"); break;
?>