...
if ($p > $p_total) {
	header("Location: ranking_desafios_saldo_negativo.php?p=1"); break;
}
...
<div class="box">
	<div class="topo_esquerdo"><div class="topo_direito"><div class="topo_meio"><h1>Ranking de Desafios de Saldo Negativo</h1></div></div></div>
...
if ($ranking_quantidade > $limite) {
	$p_nome = "ranking_desafios_saldo_negativo";
