...
if ($id == $diretor or $id == $olheiro_1 or $id == $olheiro_2 or $id == $olheiro_3) {
	header("Location: painel_olheiro3.php?msg_cupula=1"); break;
}
...
mysql_query("INSERT INTO Cargos (Time,De,Usuario,Data,Cargo) VALUES ('". $mc_time ."','". $mc_id ."','". $id ."','". $data ."',4)");
