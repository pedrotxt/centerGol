...
<div class="box">
	<div class="topo_esquerdo"><div class="topo_direito"><div class="topo_meio"><h1>Copa em dinheiro</h1></div></div></div>
	<div class="conteudo">

<div id="linha10" style="text-align: center"><a href="copa_cg.php?r=25"><img src="figuras/principal/botao_quartas.png" border="0"></a> <a href="copa_cg.php?r=26"><img src="figuras/principal/botao_semifinal.png" border="0"></a> <a href="copa_cg.php?r=27"><img src="figuras/principal/botao_final.png" border="0"></a></div>
...
<?php if ($rodada_atual < $rodada and $rodada_atual < 25) { ?>

<div id="linha10"><span class="img16"><img width="16" height="16" src="figuras/principal/alerta_nao.png"></span> Aguarde o fim da Copa Brasil.</div>

<?php } else if ($rodada_atual < $rodada and $rodada_atual > 24) { ?>
...
$query = mysql_query("SELECT Jogos.Time_2 as Time_2_ID2, Jogos.Placar_1 as Placar_1, Jogos.Placar_2 as Placar_2, Times.ID as Time_1_ID, Times.Time as Time_1_Nome FROM Jogos INNER JOIN Times ON Times.ID2 = Jogos.Time_1 WHERE Rodada = '". $rodada ."' AND Campeonato = 6 ORDER BY Jogos.ID");
...
?>
	...
	<tr height="32" <?php if ($jogo == 1 or $jogo == 3 or $jogo == 5 or $jogo == 7) { ?>bgcolor="#CCC"<?php } ?>>
...
<div id="linha10"><b>1º</b> - 1.000.000 em dinheiro e 40 de Reputação</div>
<div id="linha10"><b>2º</b> - 500.000 em dinheiro e 20 de Reputação</div>
