...
<div class="box">
	<div class="topo_esquerdo"><div class="topo_direito"><div class="topo_meio"><h1>Painel do Presidente</h1></div></div></div>
	<div class="conteudo">

<div id="linha10"><b>Salário por Rodada:</b> <?=number_format($salario_presidente,0,',','.')?></div>
<div id="linha10"><span class="img16"><img width="16" height="16" src="figuras/principal/seta1.png"></span> <a href="painel_cupula.php"><b>Definir Cúpula</b></a></div>
...
<div class="box">
	<div class="topo_esquerdo"><div class="topo_direito"><div class="topo_meio"><h1>Painel do Presidente</h1></div></div></div>
	<div class="conteudo">
<div id="linha10"><span class="img16"><img width="16" height="16" src="figuras/principal/alerta_nao.png"></span> Você não é presidente de nenhum time.</div>
	</div>
	<div class="baixo_esquerdo"><div class="baixo_direito"><div class="baixo_meio"></div></div></div>
</div>
