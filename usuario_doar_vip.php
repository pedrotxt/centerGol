...
<div id="linha10"><span class="img16"><img width="16" height="16" src="figuras/principal/alerta_nao.png"></span> Você não pode doar VIP para si mesmo.</div>
...
<div id="linha10"><span class="img16"><img width="16" height="16" src="figuras/principal/alerta_nao.png"></span> Você não tem essa quantidade de VIP!</div>

<?php } else if (anti_inj($_GET["msg_doar_vip"]) == 3) { ?>

<div id="linha10"><span class="img16"><img width="16" height="16" src="figuras/principal/alerta_nao.png"></span> Doação mínima é de 1 dia!</div>
...
<div id="linha10"><span class="fonte_form">Quanto dias você quer doar?</span> <span class="align_form"><input name="q" type="text" maxlength="2" onKeyPress="return somente_numeros(event);" style="width: 40px; height: 20px"></span></div>
...
<div id="linha10">Você não pode doar todas as unidades, tem que ficar com no mínimo 1 dia de VIP.</div>
