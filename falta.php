...
if (document.falta.palavra.value=="") {
	alert("É necessário preencher o código.");
	document.falta.palavra.focus();
	return false;
}
...
<?php
$query = mysql_query("SELECT Falta_Tent, Falta_Cod FROM Usuarios WHERE ID_Cod = password('". $_COOKIE["usuarioid"] ."')");
$rs = mysql_fetch_array($query);

$mc_tent = $rs["Falta_Tent"];
$mc_cod = $rs["Falta_Cod"];
?>

<div class="box">
	<div class="topo_esquerdo"><div class="topo_direito"><div class="topo_meio"><h1>Chutar Falta</h1></div></div></div>
	<div class="conteudo">
...
<div id="falta_swf" style="text-align: center">
...
<script type="text/javascript">
	var fo = new FlashObject("swf/falta_v6.swf?cod=<?=$mc_cod?>", "pnalti", "450", "338", "7", "#fff");
...
<form name="falta" action="falta.php" onSubmit="return verificar_entretenimento()" method="post">
